...
<template>
  <div w180 mx-auto p10 flex-col gap-8>
    ...
    <!-- ===================== Params ===================== -->
    <div>
      <h3 font-bold mb-2>Params overrides</h3>
      ...
      <div flex gap-8 items-end b-1 b-gray-200 rounded p6>
        <Swatch />
    ...
    <!-- ===================== Conditions ===================== -->
    <div>
      <h3 font-bold mb-2>Conditions</h3>
      <p text-sm text-gray-600 mb-4>
