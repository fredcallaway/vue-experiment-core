...
- The Prolific study page no longer crashes when an approved submission has no matching session metadata. These submissions are omitted from automatic assignment replacement and shown in a manual-review warning with their submission IDs.
